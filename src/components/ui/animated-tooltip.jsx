      ...
      {items.map((item) => (
        ...
        >
          ...
          <button
            ...
            className="relative flex h-14 w-14 items-center justify-center rounded-full border-2 border-background bg-muted text-base font-semibold text-primary transition duration-500 group-hover:z-30 group-hover:scale-105"
          >
            {item.initials}
          </button>
        </div>
